...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Welcome to Opulence Talent Collective — confirm your email</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          <Heading style={h1}>Welcome to the Collective</Heading>
          <Text style={text}>
          ...
          <Text style={text}>
            ...
            to activate your account and complete your application.
          </Text>
          ...
          <Hr style={divider} />
          <Text style={footer}>
            If you didn't create an account with us, you may safely disregard this message.
          </Text>
        </Section>
...
const link = { color: '#a8862e', textDecoration: 'underline' }
