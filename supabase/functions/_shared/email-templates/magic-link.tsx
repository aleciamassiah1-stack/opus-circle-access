...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your sign-in link for Opulence Talent Collective</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Click below to securely sign in to Opulence Talent Collective. This link will expire shortly.
          </Text>
          ...
          <Hr style={divider} />
          <Text style={footer}>
            If you didn't request this link, you may safely ignore this email.
          </Text>
        </Section>
